...
// LeakyBucketRateLimitAlgorithm algorithm = new
// LeakyBucketRateLimitAlgorithm(2, 10, clock);
//
// for (int i = 0; i < 10; i++) {
...
// TestClock clock = new TestClock(Instant.now());
// LeakyBucketRateLimitAlgorithm algorithm = new
// LeakyBucketRateLimitAlgorithm(2, 5, clock);
//
// for (int i = 0; i < 5; i++) {
...
// TestClock clock = new TestClock(Instant.now());
// LeakyBucketRateLimitAlgorithm algorithm = new
// LeakyBucketRateLimitAlgorithm(5, 20, clock);
//
// for (int i = 0; i < 20; i++) {
...
//
// algorithm.acceptRequest();
// assertEquals(11, algorithm.getCounter(), "Should leak 5 requests per
// second");
// }
//
// @Test
...
// TestClock clock = new TestClock(Instant.now());
// LeakyBucketRateLimitAlgorithm algorithm = new
// LeakyBucketRateLimitAlgorithm(3, 15, clock);
//
// for (int i = 0; i < 15; i++) {
// algorithm.acceptRequest();
// }
...
//
// algorithm.acceptRequest();
// assertEquals(7, algorithm.getCounter(), "Should drain 3 requests per second
// for 3 seconds");
// }
//
// @Test
...
//
// @Test
// void producerConsumerInteractionShouldBeThreadSafe() throws
// InterruptedException {
// TestClock clock = new TestClock(Instant.now());
// LeakyBucketRateLimitAlgorithm algorithm = new
// LeakyBucketRateLimitAlgorithm(10, 30, clock);
//
// for (int i = 0; i < 30; i++) {
// algorithm.acceptRequest();
// }
...
// executor.shutdown();
//
// assertEquals(20, acceptedCount.get(), "Should accept 20 after draining 20 in
// 2 seconds");
// }
//
// @Test
...
// TestClock clock = new TestClock(Instant.now());
// LeakyBucketRateLimitAlgorithm algorithm = new
// LeakyBucketRateLimitAlgorithm(5, 10, clock);
//
// algorithm.acceptRequest();
// algorithm.acceptRequest();
//
...
// TestClock clock = new TestClock(Instant.now());
// LeakyBucketRateLimitAlgorithm algorithm = new
// LeakyBucketRateLimitAlgorithm(10, 50, clock);
//
// for (int i = 0; i < 50; i++) {
// algorithm.acceptRequest();
// }
...
//
// algorithm.acceptRequest();
// assertEquals(1, algorithm.getCounter(), "Should drain completely after large
// time jump");
// }
//
// @Test
...
// TestClock clock = new TestClock(Instant.now());
// LeakyBucketRateLimitAlgorithm algorithm = new
// LeakyBucketRateLimitAlgorithm(5, 25, clock);
//
// for (int i = 0; i < 25; i++) {
// algorithm.acceptRequest();
// }
...
// executor.shutdown();
//
// assertTrue(successCount.get() <= 15, "Should drain 15 (5*3) and allow 15
// more");
// }
//
// @Test
...
// TestClock clock = new TestClock(Instant.now());
// LeakyBucketRateLimitAlgorithm algorithm = new
// LeakyBucketRateLimitAlgorithm(3, 20, clock);
//
// for (int i = 0; i < 15; i++) {
// algorithm.acceptRequest();
// }
...
//
// algorithm.acceptRequest();
// assertEquals(10, algorithm.getCounter(), "Counter should be 15 - 6 + 1 =
// 10");
// }
// }
