...
//             modifiersField.setInt(scriptField, scriptField.getModifiers() &
...
//
//         verify(template).execute(any(RedisScript.class), eq(List.of(key)), eq("10"), eq("2"),
...
//         verify(template).execute(any(RedisScript.class), eq(List.of(key)), eq("20"), eq("5"),
// anyString(), eq("1"), eq("600000"));
//     }
//
//     // ============ Token Refill Tests ============
...
//         when(template.execute(any(RedisScript.class), anyList(), anyString(), anyString(),
// anyString(), anyString(), anyString()))
//             .thenReturn(List.of(1L, 4L)); // allowed=1, remainingTokens=4 (5 refilled - 1
// consumed)
//
...
//         verify(template).execute(any(RedisScript.class), eq(List.of(key)), eq("5"), eq("0"),
// anyString(), eq("1"), eq("600000"));
//     }
//
//     @Test
...
//
//         verify(template).execute(any(RedisScript.class), eq(List.of(key1)), eq("10"), eq("2"),
// anyString(), eq("1"), eq("600000"));
//         verify(template).execute(any(RedisScript.class), eq(List.of(key2)), eq("20"), eq("5"),
// anyString(), eq("1"), eq("600000"));
//     }
//
//     @Test
